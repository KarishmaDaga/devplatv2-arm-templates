...
# <upload_code>
az storage blob upload-batch -d $AZUREML_DEFAULT_CONTAINER/score -s $local/file/path
# </upload_code>
...
--header "Authorization: Bearer $TOKEN" \
--header "Content-Type: application/json" \
--data-binary @/full/path/to/model/armtemplate.json
...
--header "Authorization: Bearer $TOKEN" \
--header "Content-Type: application/json" \
--data-binary @/full/path/to/env/armtemplate.json
# </create_environment>
...
--header "Content-Type: application/json" \
--header "Authorization: Bearer $TOKEN" \
--data-binary @/full/path/to/endpoint/armtemplate.json
#</create_endpoint>
...
--header "Content-Type: application/json" \
--header "Authorization: Bearer $TOKEN" \
--data-binary @/full/path/to/endpoint/deployment/armtemplate.json
#</create_deployment>
